...
TOKEN_FILE=$(mktemp)
echo "eyJhbGciOiJIUzI1NiIsImtpZCI6IkR0Ulp6Um9JQm5YdlJnL3IiLCJ0eXAiOiJKV1QifQ..V-IkPZEJh_8eY4SpQtLIzGHvyQ31p3tjGQi_gDo8784
" > "$TOKEN_FILE"

# URL to call
URL="https://localhost:8443/skutter-project-service/1.0/health"
